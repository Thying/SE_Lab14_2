...
// таблица проверки входной информации, индекс - код (Windows-1251) символа, значение - INEFF
// INEFF:
//  T - разрешенный символ, 
//  F - запрещенный символ,
//  I - игнорировать (не вводить), 
//  иначе - заменит значение на данное
...
namespace In
{
    struct IN
    {
        ...
        int code[256];  // таблица проверки: T - разрешенный символ, F - запрещенный, I - игнорировать, иначе новое значение
    };

    IN getin(char infile[]); // ввести Е и проверить входной поток
